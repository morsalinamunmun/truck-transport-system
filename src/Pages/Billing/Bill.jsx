        ...
        <div className="md:flex justify-between items-center">
          ...
          <div className="mt-3 md:mt-0">
            <div className="relative w-full" ref={customerSearchRef}>
              <label className="text-primary text-sm font-semibold">Search Customer</label>
              <input
                type="text"
                value={customerSearchTerm}
                onChange={(e) => {
                  setCustomerSearchTerm(e.target.value)
                  setSelectedCustomer(e.target.value) // Update filter as user types
                  setShowCustomerSuggestions(true)
                }}
                onFocus={() => setShowCustomerSuggestions(true)}
                placeholder="Type customer name or select"
                className="mt-1 w-full text-gray-500 text-sm border border-gray-300 bg-white p-2 rounded outline-none"
              />
